                    ...
                    <div class="row row-cols-md-3 row-cols-1">
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            while($row = mysqli_fetch_assoc($result)) {
                                echo '<div class="item '.$row['itemClass'].' col py-2" style="margin: auto;">';
                                echo    '<div class="card" style="max-width:350px; height: auto;">';
                                ...
                                echo                '<input type="hidden" name="info" class="info" value="'.$row['itemID'].'">';
                                echo                '<button type="submit" name="submit" class="btn btn-secondary pt-1">More information</button>';
                                echo                '</div>';
                                echo            '</form>';
                                echo        '</div>';
                                echo    '</div>';
