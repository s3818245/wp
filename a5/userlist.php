            ...
            <div class="row mx-1 p-2">
                <div class="col-lg-9 col-sm-12">
                    <table class="table table-bordered">
                        ...
                        if(!empty($_POST['delete-acc'])){
                            $deleteuser = $_POST['delete-acc'];

                            $sql = "DELETE FROM userData WHERE username ='$deleteuser';";
                                ...
                                <tr>
                                    ...
                                    <th>
                                        <form action="'.htmlspecialchars($_SERVER["PHP_SELF"]).'" method="post">
                                            <button class="btn btn-secondary" name="delete-acc" value="'.$row['username'].'">Delete account</button>
                                        </form>
                                    </th>
                                    <th>
                                        <form action="edituser.php'.header('Location: edituser.php').'" method="post">
                                            <button class="btn btn-secondary" name="edit-acc" value="'.$row['username'].'">Edit account</button>
                                        </form>
                                    </th>
                                </tr>
                            </tbody>';
                        ...
                        <tbody class="thead">
                            <tr>
                                ...
                                <th>
                                    <form action="" method>
                                        <button class="btn btn-secondary" name="delete-acc">Delete account</button>
                                    </form>
                                </th>
                            </tr>
                        </tbody>
                        -->
                        <form action="adduser.php <?php header('Location: adduser.php')?>" method = "post">
                            <button class="btn btn-secondary" name="create-acc" value="">Add account</button>
                        </form> 
                    </table>
                </div>
                <br>
