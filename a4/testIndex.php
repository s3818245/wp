        ...
        <section id="movie-synopsis">
            ...
            <div class="section-content">
                ...
                <div id="booking-content">
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" id="booking-form" onsubmit="return validateForm()" class="was-validated">
                        <div>
                            <span>
                                <h1>Booking form</h1>
                            </span>
                            ...
                            <div class="col-md-6">
                                <div class="container my-3 p-4">
                                    <div class="form-group">
                                        ...
                                        <input name="cust[name]" id="cust-name" type="text" class="form-control" pattern="^[A-Za-z\-'., ]{1,100}$" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="cust[mobile]" id="cust-mobile" type="tel" class="form-control" pattern="^(\(04\)|04|\+614)( ?\d){8}$" required>
                                        <span class="error">* <?php echo $mobileErr; ?></span>
                                    </div>

                                    <div class="form-group">
                                        <label for="credit-card">Credit Card:</label>
                                        <input name="cust[card]" id="cust-card" type="text" class="form-control" pattern="^([\d] ?){14,19}$" required>
                                    </div>
